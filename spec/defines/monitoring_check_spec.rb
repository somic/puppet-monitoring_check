...
describe 'monitoring_check' do
  ...
  context "basic test" do
    ...
    it do
      should contain_sensu__check('examplecheck') \
        ...
        .with_command('bar') \
        .with_custom({"runbook"=>"http://gronk", "dependencies"=>[], "ticket"=>false, "irc_channels"=>:undef, "tip"=>false, "project"=>false, "alert_after"=>"0", "page"=>true, "realert_every"=>"1", "sla"=>"No SLA defined.", "team"=>"operations", "notification_email"=>"undef"})
        #.with_custom({ "dependencies"=>[], "ticket"=>false, "project"=>false, "runbook"=>"http://gronk", "irc_channels"=>:undef, "realert_every"=>"1", "sla"=>"No SLA defined", "alert_after"=>"0", "tip"=>false, "page"=>true, "team"=>"operations", "notification_email"=>:undef })
    end
  end
  ...
  context "custom team" do
    ...
    it { should contain_sensu__check('examplecheck').with_custom({"runbook"=>"http://gronk", "dependencies"=>[], "ticket"=>false, "irc_channels"=>:undef, "tip"=>false, "project"=>false, "alert_after"=>"0", "page"=>false, "realert_every"=>"1", "sla"=>"No SLA defined.", "team"=>"other", "notification_email"=>"undef"}) }
  end
  ...
  context "with one dependency" do
    ...
    it { should contain_sensu__check('examplecheck').with_custom({"runbook"=>"http://gronk", "dependencies"=>["dep1"], "ticket"=>false, "irc_channels"=>:undef, "tip"=>false, "project"=>false, "alert_after"=>"0", "page"=>false, "realert_every"=>"1", "sla"=>"No SLA defined.", "team"=>"operations", "notification_email"=>"undef"}) }
  end
  context "with two dependency" do
    let(:params) { {:command => 'bar', :runbook => 'http://gronk', :dependencies => ['dep1', 'dep2']} }
    it { should contain_sensu__check('examplecheck').with_custom({"runbook"=>"http://gronk", "dependencies"=>["dep1", "dep2"], "ticket"=>false, "irc_channels"=>:undef, "tip"=>false, "project"=>false, "alert_after"=>"0", "page"=>false, "realert_every"=>"1", "sla"=>"No SLA defined.", "team"=>"operations", "notification_email"=>"undef"}) }
  end
...
{"runbook"=>"http://gronk", "dependencies"=>[], "ticket"=>false, "irc_channels"=>:undef, "tip"=>false, "project"=>false, "alert_after"=>"0", "foo"=>"bar", "page"=>false, "realert_every"=>"1", "sla"=>"No SLA defined.", "team"=>"operations", "notification_email"=>"undef"}
     ) }
  end
  context "with custom - overriding" do
    let(:params) { {:command => 'bar', :runbook => 'http://gronk', :sensu_custom => { 'team' => 'overridden' } } }
    it { should contain_sensu__check('examplecheck').with_custom(
{"runbook"=>"http://gronk", "dependencies"=>[], "ticket"=>false, "irc_channels"=>:undef, "tip"=>false, "project"=>false, "alert_after"=>"0", "page"=>false, "realert_every"=>"1", "sla"=>"No SLA defined.", "team"=>"overridden", "notification_email"=>"undef"}
    )}
  end
  context "nowake, nopage" do
    let(:params) { {:command => 'bar', :runbook => 'http://gronk', :page => 'false'} }
    it { should contain_sensu__check('examplecheck').with_custom(
{"runbook"=>"http://gronk", "dependencies"=>[], "ticket"=>false, "irc_channels"=>:undef, "tip"=>false, "project"=>false, "alert_after"=>"0", "page"=>false, "realert_every"=>"1", "sla"=>"No SLA defined.", "team"=>"operations", "notification_email"=>"undef"}
    ) }
  end
  ...
  context "With a SLA defined" do
    ...
    it { should contain_sensu__check('examplecheck').with_custom(
{"runbook"=>"http://gronk", "dependencies"=>[], "ticket"=>false, "irc_channels"=>:undef, "tip"=>false, "project"=>false, "alert_after"=>"0", "page"=>false, "realert_every"=>"1", "sla"=>"custom SLA", "team"=>"operations", "notification_email"=>"undef"}
    ) }
  end
